...
// Vì thế trong phần hướng dẫn trên github có thể nó vẫn còn giữ tên biển SibApiV35dk
...
const sendEmail = async (recipientEmail, customSubject, customHtmlContent) => {
  ...
  // Tài khoản gửi mail: lưu ý địa chỉ admin email phải là email tạo tài khoản mà các bạn tạo tài khoản trên Brevo
  sendSmtpEmail.sender = { email: env.ADMIN_EMAIL_ADDRESS, name: env.ADMIN_EMAIL_NAME }

  // Những tài khoản nhận email
  // 'to' phải là một Array để sau chúngta có thể tuỳ biến gửi 1 email tới nhiều user tuỳ chỉnh tính năng dự án nhé
  sendSmtpEmail.to = [{ email: recipientEmail }]

  // Tiêu đề của email:
  sendSmtpEmail.subject = customSubject

  // Nội dụng email dạng HTML
