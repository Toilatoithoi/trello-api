...
/** Hầu hết những thứ bên dưới đều có ở dọcs của multer, chỉ là anh tổ chức lại sao cho khoa học và gọn gàng nhất có thể
...
const customFileFilter = (req, file, callback) => {
  ...
  if (!ALLOW_COMMON_FILE_TYPES.includes(file.mimetype)) {
    const errMessage = 'File minetype is invalid. Only accept jpg, jpeg and png'
