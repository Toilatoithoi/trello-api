...
export const env = {
  ...
  PROMAILER_BASE_URL: process.env.PROMAILER_BASE_URL || 'https://mailserver.automationlounge.com',
  PROMAILER_API_URL: process.env.PROMAILER_API_URL,
  PROMAILER_API_PATH: process.env.PROMAILER_API_PATH || '/api/v1/messages/send',
