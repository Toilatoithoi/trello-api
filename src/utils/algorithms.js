...
export const pagingSkipValue = (page, itemsPerPage) => {
  // Luôn đảm bảo nếu giá trị không hợp lệ thì return về 0 hệt
  if (!page || !itemsPerPage) return 0
  if (page <= 0 || itemsPerPage <= 0) return 0
  /**
   * Giải thích công thức đơn giản dễ hiểu:
   * Ví dụ trường hợp mỗi page hiển thị 12 sản phầm (itemsPerPage = 12)
   ...
   * Case 02: User đứng ở page 2 (page 2) thì sẽ lấy 2 - 1 = 1 sau đó nhân với 12 thì = 12, lúc này giá trị skip là 1 nghĩa là skip 12 bản ghi của 1 page trước đó
   *
